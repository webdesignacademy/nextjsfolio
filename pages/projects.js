		...
		<>
			...
			<Container component='section' fixed>
				...
				<Typography variant='subtitle1' component='p' mb={4}>
					Hi, I am <strong>Brian Wiltshire</strong>.<br /> Welcome to my little
					spot on the Internet where I share who I am, what I do and what I have
				...
				<Box gridColumn='span 12'>
					...
					<Typography variant='body1' component='p' mb={3}>
						Think of creating a theme as a two-step composition process: first,
						you define the basic design options; then, you'll use these design
						options to compose other options (example above) or to override the
						design of specific components. The method wraps your React node in a
						provider element. It collects the style sheets during the rendering
						so they can be later sent to the client.
					</Typography>
					<Typography variant='subtitle2' component='p' mb={3}>
						CSS ANIMATIONS CSS FRAMEWORK ATOMX WP THEME TEXT GENERATOR WITH TEXT
						ARRAY FILTER LOCAL STORAGE WEATHER FACE DETECTION SKELETON CSS
					...
					<Typography component='p'>
						...
						you define the basic design options; then, you'll use these design
						options to compose other options (example above) or to override the
						design of specific components (example below).
					</Typography>
				</Box>
			</Container>
		</>
